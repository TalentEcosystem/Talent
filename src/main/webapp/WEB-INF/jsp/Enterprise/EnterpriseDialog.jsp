...
<input type="hidden" id="path" value="<%=path%>">
    <form class="layui-form" action="" style="border: #dedede solid 1px;background-color: #f3f3f3;">
        <input id="positionid" name="positionid" class="layui-input"  type="hidden" >
...
<%--        </div>--%>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="Domain" title="五险" type="checkbox" value="五险">
                <input name="Domain" title="公积金" type="checkbox" value="公积金">
                <input name="Domain" title="奖金提成" type="checkbox" value="奖金提成">
                <input name="Domain" title="提供住宿" type="checkbox" value="提供住宿">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
