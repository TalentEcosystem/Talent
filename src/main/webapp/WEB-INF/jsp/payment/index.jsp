...
#btn-dd1,#btn-dd2,#btn-dd3,#btn-dd4 {
	margin: 20px;
	text-align: center;
}
		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" type="text" >
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" type="text">
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" type="text">
					</dd>
					<hr class="one_line">
					<dt>商品描述：(可空)</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" type="text" >
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
