...
<head>
	...
	<title>jQuery垂直竖向焦点图轮播特效代码- JS代码网</title>

	<link href="${pageContext.request.contextPath}/homepage/css/base.css" type="text/css" rel="stylesheet">
	<link href="${pageContext.request.contextPath}/homepage/css/main.css" type="text/css" rel="stylesheet">
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-3.4.1.js" charset="UTF-8"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/homepage/js/jquery.easing.1.3.js"></script>
